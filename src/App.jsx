  ...
  <>
    <div className="wrapper d-flex flex-column justify-content-center align-items-center" data-aos="fade-up">
      <div className="font-cursive text-white display-1 position-relative text-center mb-4">
        ...
        <p className="font-inter text-white text2 h1">~ Designer / Frontend Developer</p>
      </div>
      <SocialIcons />
    </div>
  <div><br />
...
const SocialIcons = () => (
  <div className="icons d-flex justify-content-center gap-5 mt-5">
    <a href="mailto:deepikavenkatesan32@gmail.com" className='text-white'><ion-icon name="mail-outline" className="text-white" style={{ width: 40, height: 40, cursor: 'pointer' }} /></a>
    <a href="https://www.linkedin.com/in/sathiyapriya-venkatesan-9a41a127b/" className='text-white'><ion-icon name="logo-linkedin" className="text-white" style={{ width: 40, height: 40, cursor: 'pointer' }} /></a>
    <a href="https://github.com/Deepi-2704" className='text-white'><ion-icon name="logo-github" className="text-white" style={{ width: 40, height: 40, cursor: 'pointer' }} /></a>
  </div>
);
...
const AboutMe = () => (
  <>
    <div className="row container mt-2">
      ...
      <div className="col-md-5 col-sm-12 d-flex align-items-center" data-aos="fade-left">
        ...
        <h2 className="text-white text-start">About me</h2><br />
          An aspiring UI/UX Designer and Frontend Developer. Pre-final year Information Technologist. Motivated to learn something new,
          Urge to be a unique person around Believing in ‘Perseverance is the key to success!’. <br /><br /> Pre-final year IT Under Graduate Student, Passionate in Creating and Innovating! 
        </p>
      </div>
    </div>
    <div className='d-flex flex-column align-items-center justify-content-center mt-4' data-aos="fade-up">
      ...
      <a className="btn btn-outline-pink" href="https://drive.google.com/file/d/1BY8oD8FYII6DjhewTdvDJ8sTTgmDQyKW/view?usp=drive_link">Download CV</a>
  ...
  <>
    ...
    <div className="row" data-aos="fade-up">
      <div className="col-12 d-flex justify-content-center gap-md-3 gap-sm-0">
        {['HTML', 'CSS', 'Bootstrap', 'JS', 'MySQL', 'Figma'].map(skill => (
        ...
        <div className="col-md-8 col-sm-10">
          <div className="card mb-5 bg-dark border border-white p-3">
            ...
            <div className="card-body">
              <p className="h5 text-center text-white card-text">InfoDoc - Online doctor infosite in local area</p>
            </div>
          </div>
        </div>
        <div className="col-md-2 col-sm-1"></div>
      ...
      <div className="row" data-aos="fade-up">
        ...
        <div className="col-md-8 col-sm-10">
          <div className="card mb-5 bg-dark border border-white p-3">
            ...
            <div className="card-body">
              <p className="h5 text-center text-white card-text">GPA Calculator for K.S.Rangasamy College of Technology</p>
            </div>
          </div>
        </div>
        <div className="col-md-2 col-sm-1"></div>
